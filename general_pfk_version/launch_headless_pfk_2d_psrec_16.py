...
outpath = '/arc/home/pknowlton/uv_product_dir_new/test_cpu/gaussing-2d-16c-pfk'
...
cmd_mcmc = '/arc/home/pknowlton/git_repo/ALMA-Galaxy-Visibility-Modelling-PFK/general_pfk_version/launch_fittings_pfk_psrec_16.sh' #this should be the complete path to the .sh script that launches the run_fittings.py script
