...
def main():
    ...
    productname = '/arc/home/pknowlton/uv_product_dir/test5/gaussing_test5_quiet'
    ...
    with Pool() as pool:
        ...
        for sample in sampler.sample(pos, iterations=max_n, progress=False, skip_initial_state_check=True):
            ...
            tau = sampler.get_autocorr_time(tol=0, quiet=True, thin=10) #should make getting autocorr easiee
