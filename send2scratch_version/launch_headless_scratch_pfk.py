...
cmd = '/arc/home/pknowlton/git_repo/ALMA-Galaxy-Visibility-Modelling-PFK/send2scratch_version/launch_fittings_scratch_pfk.sh' #this should be the complete path to the .sh script that launches the run_fittings.py script
arglist = [in_dir, out_dir, data_path, fittype]
args = ' '.join(arglist)
